      ...
      <main className="w-full h-screen flex self-center place-content-center place-items-center">
        <div className="w-96 text-gray-600 space-y-5 p-4 shadow-xl border border-light-border dark:border-dark-border rounded-xl text-primary-dark dark:text-primary-light">
          ...
          <div className="flex flex-row text-center w-full">
            <div className="border-b border-light-border dark:border-dark-border mb-2.5 mr-2 w-full"></div>
            <div className="text-sm font-bold w-fit">OR</div>
            <div className="border-b border-light-border dark:border-dark-border mb-2.5 ml-2 w-full"></div>
          </div>
          <button
            disabled={isSigningIn}
            onClick={(e) => {
            ...
            className={`w-full flex items-center justify-center gap-x-3 py-2.5 border border-light-border dark:border-dark-border rounded-lg text-sm font-medium  ${
              isSigningIn
                ? "cursor-not-allowed"
